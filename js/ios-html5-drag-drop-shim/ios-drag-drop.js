(function(doc) {
  ...
  DragDrop.prototype = {
    ...
    dispatchDragStart: function() {
      ...
      evt.dataTransfer = {
        ...
        setDragImage: function (img) {
               console.log('using setDragImage()', self);
               self.dragImage = img.cloneNode(true);
               
               // the original copy of the dragimage is what I
               // call the 'prime'. I got it from:
    ...
    createDragImage: function() {
      var prime;
      // This is the thing that needs to be fixed.
      if (this.dragImage) {
        prime = this.primeOfDragImage;
      } else  {
        console.log('cloning this.el', this);
        this.dragImage = this.el.cloneNode(true);
        prime = this.el;
      } 
      
      duplicateStyle(prime, this.dragImage);
