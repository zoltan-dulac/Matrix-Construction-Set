...
var DragDropHelpers = new function () {
    ...
    var isIE11 = document.documentMode ? document.documentMode === 11 : false;
    ...
    me.init = function () {
        ...
        if (isIE10) {
            CSSHelpers.addClass(document.body, 'ie10');
        } else if (isIE11) {
            CSSHelpers.addClass(document.body, 'ie11');
        }
    ...
    function setEvents() {
        ...
        if (draggableNodes.length > 0) {
            for (var i = 0; i < draggableNodes.length; i++) {
                ...
                /*
                 * This block allows IE <= 10 to drag any arbitrary object, 
                 ...
                 * it.  
                 * 
                 * It also has routines that will add the class 'currentlyDragging'
                 * and 'notCurrentlyDragging', depending on what draggable objects
                 * are currently dragging and what aren't.    
                 */
    ...
    function dragStartEvent(e) {
        ...
        if (me.fixVisualCues && !doesShowVisualCues(e)) {
        ...
        for (i=0; i<draggableNodes.length; i++) {
            ...
            if (draggableNode === el) {
                ...
                CSSHelpers.addClass(draggableNode, 'notCurrentlyDragging');
            }
        }
        
        CSSHelpers.addClass(document.body, 'hasChildDragging');
    ...
    function dragEndEvent(e) {
        ...
        for (i=0; i<draggableNodes.length; i++) {
            var draggableNode = draggableNodes[i];
            CSSHelpers.removeClass(draggableNode, 'notCurrentlyDragging');
            CSSHelpers.removeClass(draggableNode, 'currentlyDragging');
        }
        
        CSSHelpers.removeClass(document.body, 'hasChildDragging');
    }
